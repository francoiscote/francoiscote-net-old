          ...
          <Container>
            <Job>
              ...
              <p>
                ...
                , the blog. From that point on I became the de-facto blog expert
                and I joined the company full-time.
              </p>
              <p>
            ...
            <Job>
              ...
              />
              <p>
                I joined Premiumbeat.com during the same month they got aquired
                by Shutterstock. The following years were spent scaling the team
                from 4 to 50 developers, implementing the <em>Scrum</em>{" "}
                methodology and the <em>Squads & Guilds</em> structure (aka{" "}
                ...
                small studio while integrating with the high-scale services of a
                tech giant.
              </p>
              <p>
                I had the opportunity to develop{" "}
                <Link href="https://www.rocketstock.com">RocketStock.com</Link>{" "}
                ...
                <Link href="https://www.premiumbeat.com">PremiumBeat.com</Link>{" "}
              ...
              <p>
                ...
                <Link href="https://www.shutterstock.com/music">Music</Link> and
            ...
            <Job>
              ...
              />
              <p>
                Previously, I worked for various Web Agencies in Montreal (
